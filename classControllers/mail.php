...
function firemail($email, $url )
{
    ...
    $mail->isHTML(true);
    $mail->Subject= "WELCOME TO FRIEND FINDER";
...
<body class="body" style="padding:0; margin:0; display:block; background:#ffffff; -webkit-text-size-adjust:none" bgcolor="#ffffff">
  <table align="center" cellpadding="0" cellspacing="0" width="100%" height="100%">
                  ...
                  <tr>
                    <td valign="top" class="mobile-block mobile-no-padding-bottom mobile-center" width="270" style="background:#1f1f1f;padding:10px 10px 10px 20px;">
                      <a href="#" style="text-decoration:none;">
                        <img src="https://res.cloudinary.com/dsuxbd237/image/upload/v1572733650/Friend%20finder/logo_clk8z1.png" width="142" height="30" alt="Your Logo" />
                      </a>
                    </td>
                        ...
                        <tr>
                          <td align="right">
                            <a href="https://facebook.com/">
                              <img src="https://res.cloudinary.com/dsuxbd237/image/upload/v1572306522/vwd2oxsgq81q0zbl4ndw.png" width="30" height="30" alt="social icon" />
                            </a>
                          </td>
                          <td align="right" style="padding-left:5px">
                            <a href="https://twitter.com/">
                              <img src="https://res.cloudinary.com/dsuxbd237/image/upload/v1572306522/hfgm5ukxig7rr4v8iztz.png" width="30" height="30" alt="social icon" />
                            </a>
                          </td>
                          <td align="right" style="padding-left:5px">
                            <a href="https://instagram.com/">
                              <img src="https://res.cloudinary.com/dsuxbd237/image/upload/v1572306522/goacthlpvdx4dkidcbb0.png" width="30" height="30" alt="social icon" />
                            </a>
                          </td>
                          <td align="right" style="padding-left:5px">
                            <a href="https://linkedin.com/">
                              <img src="https://res.cloudinary.com/dsuxbd237/image/upload/v1572306522/pz36orc1rifwlgrwhrj6.png" width="30" height="30" alt="social icon" />
                            </a>
                          </td>
                        </tr>
                      </table>
                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                      ...
                      <br>
                      We\'re excited you\'re here! Learn more about Friend Finder and activate your new account by clicking the link below!<br>
                      <br>
                      ...
                      <table cellspacing="0" cellpadding="0" width="100%" bgcolor="#ffffff">
                        <tr>
                          ...
                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:33px;v-text-anchor:middle;width:130px;" stroke="f" fillcolor="#D84A38">
                            ...
                            <center>
                          <![endif]-->
                              <a href="'.$url.'" style="background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:130px;-webkit-text-size-adjust:none;">Activate!</a>
                              <!--[if mso]>
                            </center>
                          </v:rect>
                          <![endif]-->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;">
                  <tr>
                    <td valign="top" class="mobile-padding" style="padding:20px;">
                      <h2>Subscribe to Friend Finder</h2>
                      <br>
                      You\'ll be the first to hear about news, exclusive promotions, cool collaborations, and the latest in everything.<br>
                      <br>
                      Click <b><a href="#">Subcribe</a></b><br><br>
                    </td>
                  </tr>
                </table>
              </center>
    ...
    $mail->AltBody = 'Welcome to Friend finder, click the link'.$url.' to activate your account.';
    if (!$mail->send()) {
