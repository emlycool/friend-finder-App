                  ...
                  <div class="col-lg-8 m-auto"> 
                      <div class="second">
                          ...
                          <div class="image-upload">
                                  <label for="file-input"><div class="circle"><i class="fas fa-camera"></i></div></label>
                          ...
                          <div class="jpg">JPG or PNG. Max size of 400k</div>
                              ...
                              <div class="col-sm-12">
                                  ...
                                  <input name="name" type="text" class="form-control mt-2" id="validationCustom01"  placeholder="Name" required value="<?php if(isset($_POST['name'])){ echo $_POST['name']; } ?>"></div>
                              ...
                              <div class="col-sm-12">
                                  <input name="portfolio_link" type="url" class="form-control mt-2"  id="validationCustom05" placeholder="Link to you portfolio"required value="<?php if(isset($_POST['portfolio_link'])){ echo $_POST['portfolio_link']; } ?>"></div>
                              <div class="col-sm-12">
                                  <input name="linkedin_link" type="url" class="form-control mt-2" id="validationCustom06" placeholder="Link to your Linkedin profile"required value="<?php if(isset($_POST['linkedin_link'])){ echo $_POST['linkedin_link']; } ?>"></div>
                              <div class="col-sm-12">
                                  <input name="cv_link" type="url" class="form-control mt-2"  id="validationCustom07" placeholder="Link to your cv"required value="<?php if(isset($_POST['cv_link'])){ echo $_POST['cv_link']; } ?>"></div>
                              <div class="col-sm-12">
                                  <input name="interest" type="text" class="form-control mt-2"  id="validationCustom08" placeholder="Why are you interested in mentoring with HNG?"required value="<?php if(isset($_POST['interest'])){ echo $_POST['interest']; } ?>"></div>
                              <div class="col-sm-12">
                                  <input name="state" type="text" class="form-control mt-2"  id="validationCustom09" placeholder="What state are you currently in?"required value="<?php if(isset($_POST['state'])){ echo $_POST['state']; } ?>"></div>
                              <div class="col-sm-12">
                                  <input name="employment_status" type="text" class="form-control mt-2"  id="validationCustom10" placeholder="What is your current employment status?"required value="<?php if(isset($_POST['employment_status'])){ echo $_POST['email']; } ?>"></div>
