...
?>
    <body>           
        ...
        if (isset($_GET['cat'])) {
            $category = ucfirst($_GET['cat']);                            
        }
        else{
            header("location: blog-finder.php");
        }
                            ...
                            <div class="blog_grid_inner">
                                <div class="col-md-12 col-sm-6">
                                    ...
                                    if (isset($_GET['cat'])) {
                                        ...
                                        $total_pages_sql = "SELECT COUNT(*) FROM blog_post WHERE category = '$category' ";
                                        $result = mysqli_query($mycon, $total_pages_sql);
                                        $total_rows = mysqli_fetch_array($result)[0];
                                        $total_pages = ceil($total_rows / $no_of_records_per_page);
                                        $retrive_blog_post = "SELECT * FROM blog_post WHERE category = '$category'  ORDER BY id DESC LIMIT $offset, $no_of_records_per_page"; 
                                        ...
                                        <div class="blog_grid_content">
                                            ...
                                            <div class="reaction">
                                                <div id ="refresh_<?php echo $postresult['id'];?>">
                                                    ...
                                                    <a href="post_page.php?postid=<?php echo $postresult['id'];?>" class="popup-with-zoom-anim pull-right"><i class="fa fa-comment" aria-hidden="true"></i>&nbspView comments (1)</a>
                                                    <?php
                                                    }
                                                    else{
