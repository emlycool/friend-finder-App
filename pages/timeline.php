        ...
        <div id="page-contents">
          <div class="row">
            ...
            <div class="create-post">
              ...
              ================================================= -->
              <?php
            $querypost = "SELECT * FROM social_posts WHERE poster_id = $usertoquery ORDER BY id DESC";
            ...
            <div class="post-content">
              <!--Post Date-->
                <div class="post-date hidden-xs hidden-sm">
                  <h5><?php echo $userinfo['firstname']; ?></h5>
                  <p class="text-grey"><?php echo get_timeago($postresult['date_posted']); ?></p>
                </div><!--Post Date End-->
              <?php
              ...
              <div class="post-container">
                ...
                <div class="post-detail">
                  <div class="user-info">
                    <h5><a href="timeline.php" class="profile-link"><?php echo $userinfo['firstname']." ".$userinfo['lastname']; ?></a> <span class="following"><?php echo $a; ?></span></h5>
                  ...
                  <div class="reaction" id="viewrs_<?php  echo $postresult['id']; ?>">
                    <?php
                      ...
                      $check_like = "SELECT COUNT(*) FROM social_post_likes WHERE post_id = {$postresult['id']} AND user_id = $usertoquery";
                      ...
                      $check_dislike = "SELECT COUNT(*) FROM social_post_dislikes WHERE post_id = {$postresult['id']} AND user_id = $usertoquery";
...
?>
                  ...
                  <?php
                    ...
                    while($retrieve_comment = mysqli_fetch_array($comment_exe) ){
                      ...
                      $friendlist = "SELECT DISTINCT friend_id  FROM userfriends WHERE friend_id = {$retrieve_comment['commenter_id']} AND user_id = $usertoquery LIMIT $load_count";
                    ...
                    ?>
                      <div class="post-comment">
                        ...
                        <p><a href="timeline.php" class="profile-link"><?php echo $user_details['firstname']. " ".$user_details['lastname']; ?> </a><i class="em em-lips"></i><?php echo $retrieve_comment['comment']; ?></p>
                      </div>
                  <?php
...
<!-- Mirrored from mythemestore.com/friend-finder/timeline.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Feb 2019 21:43:36 GMT -->
</html>
