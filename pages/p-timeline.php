          ...
          <div class="timeline-nav-bar hidden-sm hidden-xs">
            <div class="row">
              ...
              <div class="col-md-9">
                ...
                <ul class="follow-me list-inline" id="friend-toggle">
            ...
            <div class="post-content">
              ...
              <div class="post-container">
                ...
                <div class="post-detail">
                  <div class="user-info">
                    <h5><a href="p-timeline.php?o_user=<?php echo $postresult['id']; ?>" class="profile-link"><?php echo $userinfo['firstname']." ".$userinfo['lastname']; ?></a> <span class="following"><?php echo $a; ?></span></h5>
                  ...
                  <div class="reaction" id="viewrs_<?php  echo $postresult['id']; ?>">
                    <?php
                      ...
                      $check_like = "SELECT COUNT(*) FROM social_post_likes WHERE post_id = {$postresult['id']} AND user_id = $o_user";
                      ...
                      $check_dislike = "SELECT COUNT(*) FROM social_post_dislikes WHERE post_id = {$postresult['id']} AND user_id = $o_user";
...
?>
                  ...
                  <?php
                    ...
                    while($retrieve_comment = mysqli_fetch_array($comment_exe) ){
                      ...
                      $friendlist = "SELECT DISTINCT friend_id  FROM userfriends WHERE friend_id = {$retrieve_comment['commenter_id']} AND user_id = $o_user LIMIT $load_count";
