                            ...
                            <div class="login-form-container">
                                <div class="login-form">
                                    <form action="#" method="post" id="login-form">
                                        ...
                                        <input type="email" name="b_email" placeholder="Enter E-mail" id="user_email" required>
                                        <input type="password" name="b_password" placeholder="Password" id="password" required>
                                        <div class="button-box">
                                            ...
                                            <button type="submit" class="default-btn floatright" name="login_button" id="login_button">Sign In</button>
